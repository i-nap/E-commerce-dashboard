...
import { StarIcon, CheckIcon, AlertCircleIcon } from "lucide-react";
import AddToCartButton from "./add-to-cart-button";

export default function ProductCard({ product }: ProductCardProps) {
    // Destructure error from your custom hook
    const { handleAdd, added, error } = useAddToCart();

    return (
        <div className="w-full max-w-85 flex flex-col gap-3 h-full relative">
